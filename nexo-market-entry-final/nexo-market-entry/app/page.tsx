  ...
  es: {
    ...
    services: {
      ...
      cards: [
        ...
        { name: "Enterprise", tag: "Entrada + visado", body: "Todo lo anterior, más visado de inversión y cumplimiento normativo recurrente tras la apertura." },
      ],
  ...
  pt: {
    ...
    services: {
      ...
      cards: [
        ...
        { name: "Enterprise", tag: "Entrada + visto", body: "Tudo isso, mais visto de investidor e compliance recorrente pós-abertura." },
      ],
  ...
  en: {
    ...
    services: {
      ...
      cards: [
        ...
        { name: "Enterprise", tag: "Entry + visa", body: "Everything above, plus investor visa and recurring compliance after launch." },
      ],
