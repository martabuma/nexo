...
export const posts: Post[] = [
  {
    ...
    content: {
      es: [
        "Abrir una cuenta bancaria para una empresa con capital extranjero en Brasil siempre fue uno de los pasos que generaba más dudas. No porque la ley lo prohibiera, sino porque los bancos suelen ser cautelosos con este tipo de cliente por temas de compliance contra el lavado de dinero. En la práctica, esto se traducía en procesos más lentos y con más documentación que para una empresa 100% nacional.",
        "Un primer punto que conviene aclarar: la creencia de que solo un banco específico trabaja con capital extranjero está desactualizada. Varios bancos ofrecen esta posibilidad, cada uno con sus propios criterios internos de análisis. Algunos incluso tienen procesos de apertura totalmente digitales, sin necesidad de enviar documentación original ni presentarse en una sucursal.",
      ...
      pt: [
        "Abrir uma conta bancária para uma empresa com capital estrangeiro no Brasil sempre foi um dos passos que gerava mais dúvidas. Não porque a lei proibisse, mas porque os bancos costumam ser cautelosos com esse tipo de cliente por questões de compliance contra lavagem de dinheiro. Na prática, isso se traduzia em processos mais lentos e com mais documentação do que para uma empresa 100% nacional.",
        "Um primeiro ponto que vale esclarecer: a crença de que apenas um banco específico trabalha com capital estrangeiro está desatualizada. Vários bancos oferecem essa possibilidade, cada um com seus próprios critérios internos de análise. Alguns até têm processos de abertura totalmente digitais, sem necessidade de enviar documentação original nem comparecer a uma agência.",
      ...
      en: [
        "Opening a bank account for a company with foreign capital in Brazil has always been one of the steps that raised the most questions. Not because the law prohibited it, but because banks tend to be cautious with this type of client due to anti-money-laundering compliance concerns. In practice, this translated into slower processes with more paperwork than for a fully domestic company.",
        "One point worth clarifying first: the belief that only one specific bank works with foreign capital is outdated. Several banks offer this option, each with their own internal review criteria. Some even have fully digital account-opening processes, with no need to send original documents or visit a branch.",
